                    ...
                    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                        ...
                        <div className="row">
                            <div className=" col-lg-7  col-md-12 col-sm-12">
                                ...
                                <a href="/student/paperwork"><h5 className="attch"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
                                    <path d="M8.5 6.5a.5.5 0 0 0-1 0v3.793L6.354 9.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 10.293V6.5z" />
                                    <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
                                </svg>
                                    ورقة عمل</h5></a>
                                <a href="/student/quiz"><h5 className="attch"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-question-square" viewBox="0 0 16 16">
                            ...
                            <div className=" col-10 col-lg-4  col-md-12 col-sm-12 comments attch">
                                ...
                                <div className="d-flex flex-row add-comment-section mt-4 mb-4"><img className="img-fluid img-responsive rounded-circle mr-2" src="/images/student.png" width={38} />
                                    ...
                                    <button className="btn btn-primary btn-md" type="button">تعليق</button></div>
                            </div>
                        </div>
                    </main>
                </div>
